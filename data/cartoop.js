...
function Cart(localStorageKey) {
  const cart = {
    ...
    loadFromStorage: function () {
      this.cartVar = JSON.parse(localStorage.getItem(localStorageKey));
      if (!this.cartVar) {
        this.cartVar = [
          {
    ...
    SaveToStorage: function () {
      localStorage.setItem(localStorageKey, JSON.stringify(this.cartVar));
    },
    ...
    UpdateDeliveryOptions: function (productId, DeliveryOptionId) {
      let MatchingItem;
      this.cartVar.forEach((item) => {
